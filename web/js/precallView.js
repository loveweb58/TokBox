...
!(function (exports) {
  ...
  var setRoomName = function (roomName) {
    // document.querySelector('.user-name-modal button .room-name').textContent = 'Start Session ' + roomName;
    document.querySelector('.user-name-modal button .room-name').textContent = 'Continue';
    document.getElementById('name-heading').textContent = userName;
    document.getElementById('user-img').src = userImg;
    document.getElementById('meetingUrl').innerHTML = meetingUrl;
  };
